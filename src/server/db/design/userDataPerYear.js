...
//      2.  User's timezone year/month as we keep all the time data in faked UTC to present it easily to our users.
...
//      4.  Finally, for items that have the same year/month/model we need to be able to correctly sort them and the POSIX epoch time (ambiguous as it may be due to the issue of leap seconds) is the final arbitrer.
